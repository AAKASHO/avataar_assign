...
//   useEffect(() => {
//     if ((Math.floor((windowWidth)/200))<navItems.length&&navItems.length>1) {
//       const removedItem = navItems.pop();
//       setSubItems((pre)=>[...pre,removedItem]);
//       setNavItems([...navItems]);
//       setWindows(windowWidth);
//     }
//     else if((Math.floor((windowWidth)/200)>navItems.length)&&subItems.length>1){
//       const removedItem = subItems.pop();
//       setNavItems((pre)=>[...pre,removedItem]);
//       setSubItems([...subItems]);
//       setWindows(windowWidth);
//     }
//     console.log(Math.floor((windowWidth)/100));
